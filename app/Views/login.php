<?php require_once __DIR__ . '/partials/header.php'; ?>
    ...
    <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); max-width: 400px; margin: 40px auto;">
        ...
        <form action="/auth/processLogin" method="POST" style="display: flex; flex-direction: column; gap: 15px;">
            ...
            <button type="submit" class="btn btn-blue" style="font-size: 1.1em; padding: 10px; border: none; cursor: pointer;">Увійти</button>
        </form>
        <p style="text-align: center; margin-top: 15px;">Немає акаунта? <a href="/auth/register" style="color: #0066cc;">Зареєструватися</a></p>
    </div>
